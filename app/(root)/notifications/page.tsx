...
const Page = () => {
	...
	return (
		<main className="main-content max-md:!absolute h-full items-center justify-center">
			<header className="md:hidden bg-primary-background h-11 border-b flex items-center justify-center px-4 border-separator-elevated w-full fixed top-0 right-0">
				<button
					onClick={() => router.back()}
